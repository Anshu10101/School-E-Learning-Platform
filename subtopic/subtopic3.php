...
<script>
    history.pushState(null, null, 'subtopic3.php');
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="features1-7" style="background-color: rgb(255, 255, 255);">
	...
	<div class="mbr-section mbr-section-nopadding">
			...
			<form action="subtopic4.php" method="post" >
            ...
            <div class="row">
				...
				<div class="row row-sm-offset">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-9-email">Enter Subtopic<span class="form-asterisk">*</span></label>
	<input type="text" name="subtopicaskk" class="form-control" required="" />	
								</div>
                            </div>
