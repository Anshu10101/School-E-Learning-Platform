...
<script>
    history.pushState(null, null, 'subaskclass2.php');
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="features1-7" style="background-color: rgb(255, 255, 255);">
	...
	<div class="mbr-section mbr-section-nopadding">
			...
			<form action="subaskclass3.php" method="post" >
...
<?php
$roww = mysql_query("select * from topic where class='".$classask."' and subject='".$subjectask."'");
