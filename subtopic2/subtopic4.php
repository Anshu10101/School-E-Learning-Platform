...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="features1-7" style="background-color: rgb(255, 255, 255);">
	...
	<div class="mbr-section mbr-section-nopadding">
			...
			<form action="subtopic5.php" method="post" >
	
        <div class="container">
             <div class="row">
				<div class="row row-sm-offset">
						
						<div class="col-xs-12 col-md-3" id="hide1-2" style="visibility:visible">
					...
					value="<?php echo($topicask); ?>" />					
						...
						<div class="col-xs-12 col-md-3">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-9-email"><span class="form-asterisk"><br /></span></label>
	<input type="text" name="subtopicask" readonly="readonly" class="form-control" 
					value="<?php echo($subtopicask); ?>" />	
								</div>
                            </div>
    			</div>
        	  </div>
            ...
            <div class="row">
				...
				<div class="row row-sm-offset">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-9-email">Enter Sub-subtopic name<span class="form-asterisk">*</span></label>
	<input type="text" name="subsubtopicask" class="form-control" required="" />		
								</div>
                            </div>
