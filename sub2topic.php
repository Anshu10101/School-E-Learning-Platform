                ...
                <div class="mbr-box__magnet mbr-box__magnet--top-left mbr-section__left col-sm-8">
                    <div class="mbr-section__container">
                        <div class="mbr-header mbr-header--auto-align mbr-header--wysiwyg">
							...
							> <?php echo($_SESSION['subtopic']); ?> > Select Sub-subtopic</h4>
                        </div>
                    </div>
                </div>
            </div>
...
<?php
$rows = mysql_query("select * from subtopic2 where class='".$_SESSION['class']."'&& subject ='".$_SESSION['subject']."' && topic='".$_SESSION['topic']."' && subtopic='".$_SESSION['subtopic']."'");
...
?>
            ...
            <div class="mbr-section__col col-xs-12 col-sm-3">
                <div class="mbr-section__container mbr-section__container--last" style="padding-bottom: 31px;">
					...
					<a href="view.php?subtop-2=<?php echo($ros['subtopic2']); ?>" 
