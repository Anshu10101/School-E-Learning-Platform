...
<script>
    history.pushState(null, null, 'class.php');
                ...
                <div class="mbr-box__magnet mbr-box__magnet--top-left mbr-section__left col-sm-8">
                    <div class="mbr-section__container">
                        <div class="mbr-header mbr-header--auto-align mbr-header--wysiwyg">
							...
							<?php echo($_SESSION['class']); ?> > Select Subject</h5>
                        </div>
                    </div>
                </div>
            </div>
...
<?php
$roww = mysql_query("select * from subject where class ='".$_SESSION['class']."'");
$n = mysql_affected_rows();
if($n=="0")
		{
?>
<div class="alert alert-warning" role="alert">
        <center><b style="font-size:20px">Subject List is Empty.</b></center>
      </div>
<?php
		}
	else
...
?>
            ...
            <div class="mbr-section__col col-xs-12 col-sm-4 col-sm-6">
                <div class="mbr-section__container mbr-section__container--last" style="padding-bottom: 31px;">
					...
					<a href="subject.php?top=<?php echo($row['subject']); ?>" 
